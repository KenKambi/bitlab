...
`bitlab.registers`, `bitlab.arch`, and `bitlab.bitutils` as attributes, e.g.
`bitlab.crc.crc32(b"...")`.
"""

from . import arch, bitutils, crc, parity, registers

__version__ = "0.3.0"

__all__ = ["bitutils", "parity", "crc", "registers", "arch", "__version__"]
