...
`bitlab.registers`, `bitlab.arch`, `bitlab.comms`, and `bitlab.bitutils` as
attributes, e.g. `bitlab.crc.crc32(b"...")`.
"""

from . import arch, bitutils, comms, crc, parity, registers

__version__ = "0.4.0"

__all__ = ["bitutils", "parity", "crc", "registers", "arch", "comms", "__version__"]
